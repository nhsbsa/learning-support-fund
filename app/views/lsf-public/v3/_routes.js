...
router.post('/v3/final-year', (req, res) => {

    const finalYear = req.session.data['final-year']

    if (finalYear === 'yes') {
        res.redirect('/lsf-public/v3/full-part-time')
    } else if (finalYear === 'no') {
        res.redirect('/lsf-public/v3/course-applying-for')
    } else {
        res.redirect('/lsf-public/v3/final-year')
    }

})

// Student declaration
router.post('/v3/student-declaration', (req, res) => {
    ...
    if (studentDeclaration) {
        ...
        res.redirect('/lsf-public/v3/student-declaration')
    }
...
router.post('/v3/DHSC-first-year-application', (req, res) => {

    const firstYearApplication = req.session.data['first-year-application']

    if (firstYearApplication === "yes") {
        res.redirect('/lsf-public/v3/DHSC-aware-of-grant')
    } else {
        res.redirect('/lsf-public/v3/DHSC-confident-living-expenses')
    }

})

// Were you aware of the availability of a grant prior to applying for a Nursing, Midwifery or Allied Health professional?
router.post('/v3/DHSC-aware-of-grant', (req, res) => {

    const awareOfGrant = req.session.data['aware-of-grant']

    if (awareOfGrant === 'yes') {
        res.redirect('/lsf-public/v3/DHSC-elements')
    } else {
        res.redirect('/lsf-public/v3/DHSC-how-important-funding')
    }
...
router.post('/v3/DHSC-elements', (req, res) => {

    const awareOfGrant = req.session.data['aware-of-grant']

    res.redirect('/lsf-public/v3/DHSC-how-important-funding-study')

})

// How important was funding to your decision on where to study?
router.post('/v3/DHSC-how-important-funding', (req, res) => {
...
router.post('/v3/DHSC-how-important-funding-study', (req, res) => {

    res.redirect('/lsf-public/v3/DHSC-alternative-subjects')

})

// If you considered alternative subjects, please list them below
router.post('/v3/DHSC-alternative-subjects', (req, res) => {

    res.redirect('/lsf-public/v3/DHSC-training-grant')

})

// How will the Training Grant make a difference?
router.post('/v3/DHSC-training-grant', (req, res) => {

    res.redirect('/lsf-public/v3/DHSC-concerns-finish-course')

})

// If you have any other concerns that may affect your ability to complete the course, provide details here
router.post('/v3/DHSC-concerns-finish-course', (req, res) => {

    res.redirect('/lsf-public/v3/DHSC-which-grant-applying-for')

})

// How confident are you about being able to cover living expenses in the next year?
router.post('/v3/DHSC-confident-living-expenses', (req, res) => {

    const confidentLivingCost = req.session.data['confident-living-cost']

    res.redirect('/lsf-public/v3/DHSC-may-leave-course')

})

//Over the last year, did you ever feel that you may have to leave your course?
router.post('/v3/DHSC-may-leave-course', (req, res) => {

    const mayLeaveCourse = req.session.data['may-leave']

    if (mayLeaveCourse === "yes") {
        res.redirect('/lsf-public/v3/DHSC-factors-involved')
    } else {
        res.redirect('/lsf-public/v3/DHSC-expect-complete-final-year')
    }

})

// What were the key factors involved?
router.post('/v3/DHSC-factors-involved', (req, res) => {
...
router.post('/v3/DHSC-expect-complete-final-year', (req, res) => {

    const completeFinalYear = req.session.data['complete-final-year']

    if (completeFinalYear === "yes") {
        res.redirect('/lsf-public/v3/DHSC-work-following-graduation')
    } else {
        res.redirect('/lsf-public/v3/DHSC-reason-extra-time')
    }

})

// What is the reason for taking extra time to complete your course?
router.post('/v3/DHSC-reason-extra-time', (req, res) => {
...
router.post('/v3/DHSC-work-following-graduation', (req, res) => {

    // const workFollowingGraduation = req.session.data['work-following-graduation']

    res.redirect('/lsf-public/v3/DHSC-year-start-employment')

})

// What year do you intend to start employment?
router.post('/v3/DHSC-year-start-employment', (req, res) => {
...
router.post('/v3/DHSC-which-grant-applying-for', (req, res) => {

    const whichGrant = req.session.data['grant']

    res.redirect('/lsf-public/v3/DHSC-submit-questionnaire')

})

// Questionnaire submitted
router.post('/v3/DHSC-submit-questionnaire', (req, res) => {
...
router.post('/v3/APPLY-applied-student-loan', (req, res) => {

    const studentLoan = req.session.data['student-loan']

    if (studentLoan === 'yes') {
        res.redirect('/lsf-public/v3/APPLY-bank-details')
    } else {
        res.redirect('/lsf-public/v3/APPLY-nationality')
    }

})

// What is your nationality?
router.post('/v3/APPLY-nationality', (req, res) => {

    const nationality = req.session.data['nationality']

    res.redirect('/lsf-public/v3/APPLY-residency')

})

// Add residency
router.post('/v3/APPLY-add-residency', (req, res) => {
...
router.post('/v3/APPLY-bank-details', (req, res) => {
    ...
    res.redirect('/lsf-public/v3/APPLY-submit-your-evidence')

})

// Upload your Student loan award letter
router.post('/v3/APPLY-upload-sl-award-letter', (req, res) => {
...
// Evidence required
router.post('/v3/APPLY-submit-your-evidence', (req, res) => {
  
    res.redirect('/lsf-public/v3/APPLY-training-grant-submitted')
    
})

// You have now completed your Training Grant application
router.post('/v3/APPLY-training-grant-submitted', (req, res) => {
...
router.post('/v3/TDAE-dsa-help', (req, res) => {
  
    const dsaSupport = req.session.data['dsa-support']

    if (dsaSupport === 'yes') {
        req.session.data['TDAE-signpost'] = 'DSA'
        res.redirect('/lsf-public/v3/TDAE-signpost/TDAE-dsa-signpost')
    } else {
        res.redirect('/lsf-public/v3/TDAE-placement-journey-same-days')
    }
    
})

router.post('/v3/TDAE-placement-journey-same-days', (req, res) => {

    const sameJourneyCosts = req.session.data['same-costs']

    if (sameJourneyCosts === 'yes') {
        res.redirect('/lsf-public/v3/TDAE-incur-costs')
    } else {
        res.redirect('/lsf-public/v3/TDAE-signpost/TDAE-not-same-journey-costs')
    }

})

router.post('/v3/TDAE-incur-cost', (req, res) => {
    ...
    if (dateCostIncurred) {
        res.redirect('/lsf-public/v3/TDAE-travel-accommodation')
    } else {
        res.redirect('/lsf-public/v3/TDAE-signpost')
    }

})

router.post('/v3/TDAE-travel-accommodation', (req, res) => {
...
router.post('/v3/TDAE-normal-place-study', (req, res) => {

    res.redirect('/lsf-public/v3/TDAE-normal-return-mileage')

})

router.post('/v3/TDAE-normal-return-mileage', (req, res) => {

    res.redirect('/lsf-public/v3/TDAE-normal-additional-costs-often')

})

router.post('/v3/TDAE-normal-additional-costs-often', (req, res) => {

    const normalOftenAdditionalCosts = req.session.data['normal-often-additional-costs']

    if (normalOftenAdditionalCosts === 'no') {
        res.redirect('/lsf-public/v3/TDAE-normal-summary-cya')
    } else {
        res.redirect('/lsf-public/v3/TDAE-additional-costs')
    }

})

router.post('/v3/TDAE-additional-costs', (req, res) => {

    res.redirect('/lsf-public/v3/TDAE-additional-costs-comments')

})

router.post('/v3/TDAE-additional-costs-comments', (req, res) => {

    const provideComments = req.session.data['related-comments']

    if (provideComments === 'yes') {
        res.redirect('/lsf-public/v3/TDAE-comments')
    } else {
        res.redirect('/lsf-public/v3/TDAE-normal-summary-cya')
    }
...
router.post('/v3/TDAE-comments', (req, res) => {
...
router.post('/v3/TDAE-placement-return-mileage', (req, res) => {
    ...
    res.redirect('/lsf-public/v3/TDAE-placement-additional-costs-often')

})

router.post('/v3/TDAE-placement-additional-costs-often', (req, res) => {

    const oftenAdditionalCosts = req.session.data['often-additional-costs']

    if (oftenAdditionalCosts === 'no') {
        res.redirect('/lsf-public/v3/TDAE-placement-address')
    } else {
        res.redirect('/lsf-public/v3/TDAE-placement-additional-costs')
    }

})

router.post('/v3/TDAE-placement-additional-costs', (req, res) => {

    res.redirect('/lsf-public/v3/TDAE-placement-additional-comments')

})

router.post('/v3/TDAE-placement-additional-comments', (req, res) => {

    const placementAdditionalComments = req.session.data['placement-related-comments']

    if (placementAdditionalComments === 'yes') {
        res.redirect('/lsf-public/v3/TDAE-placement-comments')
    } else {
        res.redirect('/lsf-public/v3/TDAE-placement-address')
    }
...
router.post('/v3/TDAE-placement-comments', (req, res) => {
...
router.post('/v3/TDAE-start-claim', (req, res) => {

    res.redirect('/lsf-public/v3/TDAE-end-claim')

})

router.post('/v3/TDAE-end-claim', (req, res) => {
    ...
    if (startDate === '05-12-2022' && endDate === '09-12-2022') {
        res.redirect('/lsf-public/v3/TDAE-days-claiming')
    } else if (startDate === '28-11-2022' && endDate === '09-12-2022'){
        req.session.data['TDAE-multiple-weeks'] = 'yes'
        res.redirect('/lsf-public/v3/TDAE-claiming-same-days')
    } else {
        res.redirect('/lsf-public/v3/TDAE-end-claim')
    }
...
router.post('/v3/TDAE-claiming-same-days', (req, res) => {
    ...
    if (claimingSameDays === 'yes'){
        ...
        res.redirect('/lsf-public/v3/TDAE-what-days-claiming-week')
    }

})

router.post('/v3/TDAE-what-days-claiming-week', (req, res) => {

    res.redirect('/lsf-public/v3/TDAE-provide-journey-evidence')

})

router.post('/v3/TDAE-what-days-claiming-week-2', (req, res) => {

    res.redirect('/lsf-public/v3/TDAE-provide-journey-evidence-2')

})

router.post('/v3/TDAE-what-days-claiming-week-cya', (req, res) => {

    res.redirect('/lsf-public/v3/TDAE-placement-return-mileage')

})

router.post('/v3/TDAE-days-claiming', (req, res) => {

    res.redirect('/lsf-public/v3/TDAE-provide-journey-evidence-2')

})

router.post('/v3/TDAE-type-journey-evidence', (req, res) => {

    res.redirect('/lsf-public/v3/TDAE-provide-journey-evidence')

})

router.post('/v3/TDAE-placement-journey-evidence', (req, res) => {

    res.redirect('/lsf-public/v3/TDAE-evidence-summary')

})

router.post('/v3/TDAE-add-evidence-week', (req, res) => {
